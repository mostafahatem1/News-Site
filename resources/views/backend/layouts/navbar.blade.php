    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown"
                ...
                <!-- Counter - Alerts -->
                @if ($unreadCount > 0)
                <span id="unread-count" class="badge badge-danger badge-counter">{{ $unreadCount }}</span>
                @endif
            </a>
            <!-- Dropdown - Alerts -->
            <div id="notification-item" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <div id="notification-list">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="{{ $data['link'] ?? '#' }}">
                        ...
                        <div>
                            ...
                            <span class="font-weight-bold">{{ $data['title'] ?? 'New Notification' }}</span>
                            <div>{{ $data['name'] ?? '' }}</div>
                        </div>
                    </a>
                    @empty
